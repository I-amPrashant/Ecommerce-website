  ...
  return (
    <div className="min-h-screen flex justify-center items-center text-5xl">
      <div className="max-w-[700px] mx-auto text-white text-center">
        ...
        <h1 className="font-serif text-3xl md:text-[80px] italic md:leading-[80px] font-medium">
        ...
        <Link to='/shop' className="text-base mt-6 bg-[#000] text-[#fff] py-2 px-6 inline-block hover:bg-[#fff] hover:text-[#000] border
        duration-150 ease-linear transition-all">
          <button className="outline-none border-none py-3 px-6">View Collection</button>
        </Link>
      </div>
    </div>
  );
